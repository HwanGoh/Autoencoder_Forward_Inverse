...
#                             Training Properties                             #
###############################################################################
def optimize(hyperp, run_options, file_paths, NN, obs_indices, loss_autoencoder, loss_inverse_problem, loss_model_augmented, relative_error, parameter_and_state_obs_train, parameter_and_state_obs_val, parameter_and_state_obs_test, parameter_dimension, num_batches_train):
    ...
    mean_loss_train_inverse_problem = tf.keras.metrics.Mean()
    ...
    mean_loss_val_inverse_problem = tf.keras.metrics.Mean()
    ...
    mean_loss_test_inverse_problem = tf.keras.metrics.Mean()
    ...
    storage_array_loss_train_inverse_problem = np.array([])
    ...
    storage_array_loss_val_inverse_problem = np.array([])
    ...
    storage_array_loss_test_inverse_problem = np.array([])
...
###############################################################################
    ...
    def train_step(batch_parameter_train, batch_state_obs_train):
        with tf.GradientTape() as tape:
            ...
            batch_loss_train_inverse_problem = loss_inverse_problem(batch_parameter_pred_train, batch_parameter_train, hyperp.penalty)
        ...
        mean_loss_train_inverse_problem(batch_loss_train_inverse_problem)
    ...
    def val_step(batch_parameter_val, batch_state_obs_val):
        ...
        batch_loss_val_inverse_problem = loss_inverse_problem(batch_parameter_pred_val, batch_parameter_val, hyperp.penalty)
        ...
        mean_loss_val_inverse_problem(batch_loss_val_inverse_problem)
    ...
    def test_step(batch_parameter_test, batch_state_obs_test):
        ...
        batch_loss_test_inverse_problem = loss_inverse_problem(batch_parameter_pred_test, batch_parameter_test, hyperp.penalty)
        ...
        mean_loss_test_inverse_problem(batch_loss_test_inverse_problem)
...
############################################################################### 
    ...
    for epoch in range(hyperp.num_epochs):
        ...
        with summary_writer.as_default():
            ...
            tf.summary.scalar('loss_training_inverse_problem', mean_loss_train_inverse_problem.result(), step=epoch)
            ...
            tf.summary.scalar('loss_val_inverse_problem', mean_loss_val_inverse_problem.result(), step=epoch)
            ...
            tf.summary.scalar('loss_test_inverse_problem', mean_loss_test_inverse_problem.result(), step=epoch)
        ...
        storage_array_loss_train_inverse_problem = np.append(storage_array_loss_train_inverse_problem, mean_loss_train_inverse_problem.result())
        ...
        storage_array_loss_val_inverse_problem = np.append(storage_array_loss_val_inverse_problem, mean_loss_val_inverse_problem.result())
        ...
        storage_array_loss_test_inverse_problem = np.append(storage_array_loss_test_inverse_problem, mean_loss_test_inverse_problem.result())
        ...
        print('Train Loss: Full: %.3e, State: %.3e, Parameter: %.3e, State Aug: %.3e' %(mean_loss_train.result(), mean_loss_train_autoencoder.result(), mean_loss_train_inverse_problem.result(), mean_loss_train_model_augmented.result()))
        print('Val Loss: Full: %.3e, State: %.3e, Parameter: %.3e, State Aug: %.3e' %(mean_loss_val.result(), mean_loss_val_autoencoder.result(), mean_loss_val_inverse_problem.result(), mean_loss_val_model_augmented.result()))
        print('Test Loss: Full: %.3e, State: %.3e, Parameter: %.3e, State Aug: %.3e' %(mean_loss_test.result(), mean_loss_test_autoencoder.result(), mean_loss_test_inverse_problem.result(), mean_loss_test_model_augmented.result()))
    ...
    return storage_array_loss_train, storage_array_loss_train_autoencoder, storage_array_loss_train_inverse_problem, storage_array_loss_train_model_augmented, storage_array_loss_val, storage_array_loss_val_autoencoder, storage_array_loss_val_inverse_problem, storage_array_loss_val_model_augmented, storage_array_loss_test, storage_array_loss_test_autoencoder, storage_array_loss_test_inverse_problem, storage_array_loss_test_model_augmented, storage_array_relative_error_state_autoencoder, storage_array_relative_error_state_forward_problem, storage_array_relative_error_parameter 