...
#                             Training Properties                             #
###############################################################################
def optimize(hyperp, run_options, file_paths, NN, loss_autoencoder, loss_inverse_problem, relative_error, parameter_and_state_obs_train, parameter_and_state_obs_val, parameter_and_state_obs_test, parameter_dimension, num_batches_train):
    #=== Optimizer ===#
...
###############################################################################
    ...
    def train_step(batch_parameter_train, batch_state_obs_train):
        with tf.GradientTape() as tape:
            ...
            batch_loss_train = batch_loss_train_autoencoder + batch_loss_train_inverse_problem
    ...
    def val_step(batch_parameter_val, batch_state_obs_val):
        ...
        batch_loss_val = batch_loss_val_autoencoder + batch_loss_val_inverse_problem
    ...
    def test_step(batch_parameter_test, batch_state_obs_test):
        ...
        batch_loss_test = batch_loss_test_autoencoder + batch_loss_test_inverse_problem
...
############################################################################### 
    ...
    for epoch in range(hyperp.num_epochs):
        ...
        with summary_writer.as_default():
            ...
            tf.summary.scalar('relative_error_parameter_inverse_problem', mean_relative_error_state_forward_problem.result(), step=epoch)
    ...
    return storage_array_loss_train, storage_array_loss_train_autoencoder, storage_array_loss_train_inverse_problem, storage_array_loss_val, storage_array_loss_val_autoencoder, storage_array_loss_val_inverse_problem, storage_array_loss_test, storage_array_loss_test_autoencoder, storage_array_loss_test_inverse_problem, storage_array_relative_error_state_autoencoder, storage_array_relative_error_state_forward_problem, storage_array_relative_error_parameter 