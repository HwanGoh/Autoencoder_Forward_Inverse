...
class FilePaths():              
    def __init__(self, hyperp, run_options): 
        ...
        #=== File Name ===#
        self.filename = self.autoencoder_type + self.autoencoder_loss + '_' + self.dataset + run_options.N_Nodes + '_' + hyperp.data_type + fin_dimension + '_hl%d_tl%d_hn%d_%s_p%s_d%d_b%d_e%d' %(hyperp.num_hidden_layers, hyperp.truncation_layer, hyperp.num_hidden_nodes, hyperp.activation, penalty_string, run_options.num_data_train, hyperp.batch_size, hyperp.num_epochs)
