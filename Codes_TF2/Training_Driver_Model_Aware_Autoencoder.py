...
from Utilities.loss_and_relative_errors import loss_autoencoder, loss_encoder_or_decoder, relative_error, reg_prior
...
def trainer(hyperp, run_options, file_paths):
    ...
    if run_options.use_distributed_training == 0:        
        ...
        = optimize(hyperp, run_options, file_paths, NN, loss_autoencoder, loss_encoder_or_decoder, relative_error, reg_prior, L_pr,\
                   parameter_and_state_obs_train, parameter_and_state_obs_val, parameter_and_state_obs_test,\
    ...
    if run_options.use_distributed_training == 1:
        ...
        = optimize_distributed(dist_strategy, GLOBAL_BATCH_SIZE,
                               hyperp, run_options, file_paths, NN, loss_autoencoder, loss_encoder_or_decoder, relative_error,\
                               parameter_and_state_obs_train, parameter_and_state_obs_val, parameter_and_state_obs_test,\
                               parameter_dimension, num_batches_train)
