...
from Utilities.get_wave_data import load_wave_data
from Utilities.NN_Autoencoder_RNN_Fwd_Inv import AutoencoderRNNFwdInv
...
class RunOptions:
    def __init__(self, hyper_p): 
        ...
        self.filename = hyper_p.data_type + '_' + self.computational_domain + '_' + self.computation_domain_discretization + '_hl%d_tl%d_hn%d_p%s_d%d_b%d_e%d' %(hyper_p.num_hidden_layers, hyper_p.truncation_layer, hyper_p.num_hidden_nodes, penalty_string, hyper_p.num_training_data, hyper_p.batch_size, hyper_p.num_epochs)
