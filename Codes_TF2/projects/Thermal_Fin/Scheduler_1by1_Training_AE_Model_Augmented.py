...
from Training_Driver_AE_Model_Augmented import Hyperparameters
...
if __name__ == '__main__':
    ...
    for num, scenario in enumerate(scenarios_class_instances):
        ...
        proc = subprocess.Popen(['./Training_Driver_AE_Model_Augmented.py',
            ...
            f'{scenario.penalty:.4f}', f'{scenario.penalty_aug:.3f}',
            f'{scenario.batch_size}', f'{scenario.num_epochs}', f'{scenario.which_gpu}'])
        proc.wait()
