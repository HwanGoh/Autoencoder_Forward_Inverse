...
if __name__ == "__main__":
    ...
    project_name = 'ironwater_benchmark_'
    data_options =\
            'r1%d_r2%d_r3%d' %(run_options.r_1, run_options.r_2, run_options.r_3)
    dataset_directory = '../../../../Datasets/Neutron_Transport/ironwater_benchmark/'
