...
from Training_Driver_Model_Induced_Autoencoder_Vary_3D import Hyperparameters
...
if __name__ == '__main__':
    ...
    hyperp.penalty           = [1, 10, 50]
    hyperp.penalty_aug       = [1, 10, 50]
