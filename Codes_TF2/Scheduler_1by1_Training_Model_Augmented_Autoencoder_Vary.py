...
from Training_Driver_Model_Augmented_Autoencoder_Vary import Hyperparameters
...
if __name__ == '__main__':
    ...
    for num, scenario in enumerate(scenarios_class_instances):
        ...
        proc = subprocess.Popen(['./Training_Driver_Model_Augmented_Autoencoder_Vary.py', f'{scenario.data_type}', f'{scenario.num_hidden_layers}', f'{scenario.truncation_layer}', f'{scenario.num_hidden_nodes}', f'{scenario.activation}', f'{scenario.penalty_aug:.3f}', f'{scenario.batch_size}', f'{scenario.num_epochs}', f'{scenario.which_gpu}']) 
        proc.wait()
