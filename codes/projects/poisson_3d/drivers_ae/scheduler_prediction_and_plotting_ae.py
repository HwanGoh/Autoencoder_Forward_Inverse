...
def generate_scenarios_list():
    ...
    hyperp['penalty_encoder']           = [1500, 3000, 5000, 10000]
    hyperp['penalty_decoder']           = [10]
    hyperp['penalty_aug']               = [1500, 3000, 5000, 10000]
...
if __name__ == '__main__':
    ...
    for scenario in scenarios_list:
        ...
        #         ['./prediction_and_plotting_ae.py', f'{scenario_json}'])
        proc = subprocess.Popen(
                ['./plotting_paraview_ae.py', f'{scenario_json}'])
        proc.wait()
