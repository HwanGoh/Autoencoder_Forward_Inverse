...
#                                 All Data                                    #
###############################################################################
def load_prior(options, file_paths,
        load_mean = 0,
        load_covariance = 0,
    ...
    if load_mean == 1:
        ...
        prior_mean = np.zeros(options.parameter_dimensions)
    ...
    if load_covariance == 1:
        ...
        prior_covariance = prior_covariance.reshape((options.parameter_dimensions,
            options.parameter_dimensions))
    else:
        prior_covariance = np.identity(options.parameter_dimensions)
    ...
    if load_covariance_cholesky == 1:
        ...
        prior_covariance_cholesky =\
                prior_covariance_cholesky.reshape((options.parameter_dimensions,
            options.parameter_dimensions))
    else:
        prior_covariance_cholesky = np.identity(options.parameter_dimensions)
    ...
    if load_covariance_cholesky_inverse == 1:
        ...
        prior_covariance_cholesky_inverse =\
                prior_covariance_cholesky_inverse.reshape((options.parameter_dimensions,
            options.parameter_dimensions))
    else:
        prior_covariance_cholesky_inverse = np.identity(options.parameter_dimensions)
