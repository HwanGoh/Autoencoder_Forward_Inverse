...
class RunOptions:
    ...
    diagonal_posterior_covariance = 1
    IAF_posterior = 0
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        hyperp.penalty_KLD_incr          = float(sys.argv[6])
        hyperp.penalty_KLD_rate          = int(sys.argv[7])
        hyperp.penalty_post_mean         = float(sys.argv[8])
